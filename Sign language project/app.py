...
class Application:
    ...
    def action_call(self) :
        ...
        self.photo1 = tk.PhotoImage(file='Pictures/1.png')
        self.w1 = tk.Label(self.root1, image = self.photo1)
        self.w1.place(x = 50, y = 105)
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x = 50,y = 250)
        self.tx6.config(text = "Aanchal Gupta\n1914110281", font = ("Courier",15,"bold"))

        self.photo2 = tk.PhotoImage(file='Pictures/1.png')
        self.w2 = tk.Label(self.root1, image = self.photo2)
        self.w2.place(x = 260, y = 105)
        self.tx2 = tk.Label(self.root1)
        self.tx2.place(x = 260,y = 250)
        self.tx2.config(text = "Aditi Gupta\n1914110284", font = ("Courier",15,"bold"))

        self.photo3 = tk.PhotoImage(file='Pictures/1.png')
        self.w3 = tk.Label(self.root1, image = self.photo3)
        self.w3.place(x = 480, y = 105)
        self.tx3 = tk.Label(self.root1)
        self.tx3.place(x = 480,y = 250)
        self.tx3.config(text = "Aditya Singh\n1914110286", font = ("Courier",15,"bold"))

        self.photo4 = tk.PhotoImage(file='Pictures/1.png')
        self.w4 = tk.Label(self.root1, image = self.photo4)
        self.w4.place(x = 700, y = 105)
        self.tx4 = tk.Label(self.root1)
        self.tx4.place(x = 700,y = 250)
        self.tx4.config(text = "Sarthak Goel\n1914110316", font = ("Courier",15,"bold"))
        ...
        self.photo6 = tk.PhotoImage(file='Pictures/2.png')
        self.w6 = tk.Label(self.root1, image = self.photo6)
        self.w6.place(x = 350, y = 420)
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x = 200,y = 670)
        self.tx6.config(text = "Prof. Trupti Suryawanshi", font = ("Courier",30,"bold"))
